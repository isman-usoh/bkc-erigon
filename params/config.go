...
var (
	...
	BkcMainnetGenesisHash = libcommon.HexToHash("0x8a0f3e54f57e9307b63470c37fbc34d41b45a7c63e3095a8d4511faff7158071")
	BkcTestnetGenesisHash = libcommon.HexToHash("0x4b96d514cdc1c5575aa1d08d53e93696cbed58ce28c7126acb5ea29e7c898409")
	BkcDevnetGenesisHash  = libcommon.HexToHash("0x4c3ba641ed202a69aa3aa27a945f35d07bbaacf6b6a6765c4d3a71a45e7d7c4f")
)
...
var (
	...
	BkcMainnetChainConfig = readChainSpec("chainspecs/bkc-mainnet.json")

	BkcTestnetChainConfig = readChainSpec("chainspecs/bkc-testnet.json")

	BkcDevnetChainConfig = readChainSpec("chainspecs/bkc-devnet.json")
...
func ChainConfigByChainName(chain string) *chain.Config {
	...
	case networkname.BkcMainnetChainName:
		return BkcMainnetChainConfig
	case networkname.BkcTestnetChainName:
		return BkcTestnetChainConfig
	case networkname.BkcDevnetChainName:
		return BkcDevnetChainConfig
	default:
		return nil
	}
}
...
func GenesisHashByChainName(chain string) *libcommon.Hash {
	...
	case networkname.BkcMainnetChainName:
		return &BkcMainnetGenesisHash
	case networkname.BkcTestnetChainName:
		return &BkcTestnetGenesisHash
	case networkname.BkcDevnetChainName:
		return &BkcDevnetGenesisHash
	default:
		return nil
	}
}
...
func ChainConfigByGenesisHash(genesisHash libcommon.Hash) *chain.Config {
	...
	case genesisHash == ChiadoGenesisHash:
		return ChiadoChainConfig
	case genesisHash == BkcMainnetGenesisHash:
		return BkcMainnetChainConfig
	case genesisHash == BkcTestnetGenesisHash:
		return BkcTestnetChainConfig
	case genesisHash == BkcDevnetGenesisHash:
		return BkcDevnetChainConfig
	default:
		return nil
	}
